...
When the user asks about dependency vulnerabilities, CVEs, supply-chain risk, or security of `package.json` / lockfiles:

1. Use the **tridentchain** MCP tools (or CLI fallback below).
